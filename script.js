...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.project-card, .skill-item, .stat, .about-text, .contact-info');
...
// Cargar animaciones cuando la página esté lista
window.addEventListener('load', () => {
    // Asegurar que todas las animaciones se ejecuten
    setTimeout(() => {
